...
public class LogTable
  extends JTable
  implements TableColumnModelListener, MouseListener, ListSelectionListener
{
  ...
  public void adjustSize()
  {
    ...
    LogViewer.logTable.setPreferredSize(new Dimension(width, LogViewer.logModel.getRowCount() * LogViewer.logTable.getRowHeight()));
    LogViewer.logTable.revalidate();
    

    TableColumnModel tcm = LogViewer.logTable.getColumnModel();
    for (int col = 0; col < LogViewer.logModel.getColumnCount(); col++) {
      tcm.getColumn(col).setPreferredWidth(LogViewer.logModel.getColumnWidth(col));
    }
  }
  ...
  public void mouseClicked(MouseEvent e)
  {
    if (e.getButton() == 1)
    {
      if ((e.getSource() instanceof JTableHeader))
      {
        ...
        Rectangle r = this.tableHeader.getTable().getCellRect(0, col, false);
